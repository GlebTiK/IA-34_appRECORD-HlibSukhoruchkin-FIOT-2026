...
**Мета:** створити зручний і простий у використанні веб-застосунок про цуценят, який дозволяє користувачам швидко переглядати каталог та заповнювати заявку на візит. Сайт має мати приємний інтерфейс, показувати цуценят із фото та описами і спрощувати вибір.
